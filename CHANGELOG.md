...
- **Configurable bottom bar.** Choose which actions ride the bottom bar. A "Customize toolbar" mode in
  the menu pins or unpins any action (Center, Follow, Charts, Forecast, Tides, Anchor, and the rest);
